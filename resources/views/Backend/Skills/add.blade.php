...
<div class="card-body p-0 border-0 shadow-lg">
    ...
    <form class="user" method="post" action="{{route('skill.store')}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="p-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="number" name="ability" required placeholder="Enter Skill Ability in percent"
