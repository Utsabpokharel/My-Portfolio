            ...
            <div class="col-md-12">
                <div class="p-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="file" name="thumbnail" placeholder="Enter Service Image" accept="image/*"
                                id="image-file" class="form-control   @error('thumbnail') is-invalid @enderror"
                                onchange="readURL(this);" value="{{old('thumbnail','')}}" />
                            <img src="{{asset('Uploads/Services/'.$service->thumbnail)}}" alt="image" id="image-preview"
                                width="150px">
                            @error('thumbnail')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
