...
<div class="card-body p-0 border-0 shadow-lg">
    ...
    {{-- Add --}}
    <form class="user" method="post" action="{{route('interest.store')}}" enctype="multipart/form-data">
        @csrf
        @if ($errors->any())
            ...
            <div class="col-md-12">
                <div class="p-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="file" name="icon" required placeholder="Enter Icon" accept="image/*"
