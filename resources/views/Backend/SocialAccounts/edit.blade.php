...
<div class="page-title-breadcrumb pull-left">
    <ol class="breadcrumb page-breadcrumb ">
        ...
        <li class="active">Edit Social Account</li>
    </ol>
</div>
...
<div class="card-body p-0 border-0 shadow-lg">
    ...
    <form class="user" method="post" action="{{route('socialaccount.update',$socialaccount->id)}}"
            ...
            <div class="col-md-12">
                <div class="p-4">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="social_site" required placeholder="Enter Social Site Name"
                                ...
                                value="{{old('social_site',$socialaccount->social_site)}}" />
                            <span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="file" name="icon" placeholder="Enter Social icon" accept="image/*"
                                id="image-file" class="form-control   @error('icon') is-invalid @enderror"
                                onchange="readURL(this);" value="{{old('icon','')}}" />
                            <img src="{{asset('Uploads/SocialAccount/'.$socialaccount->icon)}}" alt="image"
